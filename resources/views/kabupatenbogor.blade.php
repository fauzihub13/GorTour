        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="bd-placeholder-img w-100 vh-100" src="{{ asset('assets/images/gunung-pancar-2.jpg') }}">
                    <div class="container">
                ...
                <div class="carousel-item">
                    <img class="bd-placeholder-img w-100 vh-100" src="{{ asset('assets/images/jungadv.jpg') }}">
                    <div class="container">
                        <div class="carousel-caption">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <div class="media-1">
                <a class="media-thumb" href="{{ asset('assets/images/Danau-Jayamix-Rumpin.jpg') }}" data-fancybox="gallery">
                  ...
                  <img src="{{ asset('assets/images/Danau-Jayamix-Rumpin.jpg') }}" alt="Image" class="img-fluids">
                </a>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <div class="media-1">
                <a class="media-thumb" href="{{ asset('assets/images/Curug-Seribu.jpg') }}" data-fancybox="gallery">
                  <div class="media-text">
                    <h3>Curug Seribu</h3>
                    <span class="location">Kabupaten Bogor</span>
                    <div class="media-stars">
                  ...
                  <img src="{{ asset('assets/images/Curug-Seribu.jpg') }}" alt="Image" class="img-fluids">
                </a>
          ...
          <div class="row pt-5 mt-1">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <div class="media-1">
                <a class="media-thumb" href="{{ asset('assets/images/Curug-Cibaliung.png') }}" data-fancybox="gallery">
                  <div class="media-text">
                  ...
                  <img src="{{ asset('assets/images/Curug-Cibaliung.png') }}" alt="Image" class="img-fluids">
                </a>
      ...
      <div class="untree_co-section mt-5">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <div class="media-1">
                <a class="media-thumb" href="{{ asset('assets/images/NICOLES_RIVER_PARK.jpg') }}" data-fancybox="gallery">
                  <div class="media-text">
                  ...
                  <img src="{{ asset('assets/images/NICOLES_RIVER_PARK.jpg') }}" alt="Image" class="img-fluids">
                </a>
          ...
          <div class="row pt-5 mt-1">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <div class="media-1">
                <a class="media-thumb" href="{{ asset('assets/images/Taman-Budaya-Sentul.jpg') }}" data-fancybox="gallery">
                  <div class="media-text">
                  ...
                  <img src="{{ asset('assets/images/Taman-Budaya-Sentul.jpg') }}" alt="Image" class="img-fluids">
                </a>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <div class="media-1">
                <a class="media-thumb" href="{{ asset('assets/images/Nirvana-Valley-Resort.png') }}" data-fancybox="gallery">
                  <div class="media-text">
                  ...
                  <img src="{{ asset('assets/images/Nirvana-Valley-Resort.png') }}" alt="Image" class="img-fluids">
                </a>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
            <div class="media-1">
              <a class="media-thumb" href="{{ asset('assets/images/Water-Kingdom.jpg') }}" data-fancybox="gallery">
                <div class="media-text">
                  <h3>Water Kingdom</h3>
                  <span class="location">Kabupaten Bogor</span>
                  <div class="media-stars">
                ...
                <img src="{{ asset('assets/images/Water-Kingdom.jpg') }}" alt="Image" class="img-fluids">
              </a>
          ...
          <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
            <div class="media-1">
              <a class="media-thumb" href="{{ asset('assets/images/JungleLand-Adventure.jpg') }}" data-fancybox="gallery">
                <div class="media-text">
                ...
                <img src="{{ asset('assets/images/JungleLand-Adventure.jpg') }}" alt="Image" class="img-fluids">
              </a>
